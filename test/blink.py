...
sources = [
    ...
    "user_code/freertos.c",
    "user_code/main.c",
    "user_code/stm32f3xx_hal_msp.c",
    "user_code/stm32f3xx_hal_timebase_TIM.c",
...
for source in sources:
    file = project.get_file(source_folder + source)
    files.append(file)
...
eprint("Reload main.h")
project.reload_file(source_folder + "Inc/main.h")
project.wait_for_analysis()

eprint("Exclude all files one by one")
for file in files:
