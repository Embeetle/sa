...
#define __ELF__ 1
#define CONFIG_HAS_HPMSDK_ACMP y
#define CONFIG_HAS_HPMSDK_ADC16 y
#define CONFIG_HAS_HPMSDK_CRC y
#define CONFIG_HAS_HPMSDK_DAC y
#define CONFIG_HAS_HPMSDK_DMA y
#define CONFIG_HAS_HPMSDK_GPIO y
#define CONFIG_HAS_HPMSDK_GPTMR y
#define CONFIG_HAS_HPMSDK_I2C y
#define CONFIG_HAS_HPMSDK_LIN y
#define CONFIG_HAS_HPMSDK_MCAN y
#define CONFIG_HAS_HPMSDK_MCHTMR y
#define CONFIG_HAS_HPMSDK_PCFG y
#define CONFIG_HAS_HPMSDK_PLA y
#define CONFIG_HAS_HPMSDK_PLLCTLV2 y
#define CONFIG_HAS_HPMSDK_PMP y
#define CONFIG_HAS_HPMSDK_PMU y
#define CONFIG_HAS_HPMSDK_PTPC y
#define CONFIG_HAS_HPMSDK_PWM y
#define CONFIG_HAS_HPMSDK_RNG y
#define CONFIG_HAS_HPMSDK_RTC y
#define CONFIG_HAS_HPMSDK_SDM y
#define CONFIG_HAS_HPMSDK_SDP y
#define CONFIG_HAS_HPMSDK_SPI y
#define CONFIG_HAS_HPMSDK_TSNS y
#define CONFIG_HAS_HPMSDK_UART y
#define CONFIG_HAS_HPMSDK_USB y
#define CONFIG_HAS_HPMSDK_WDG y
#define FLASH_XIP 1
